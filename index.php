...
$menu_links = ['Introduzione', 'Norme sulla privacy', 'Termini di servizio', 'Tecnologie', 'Domande frequenti'];
...
<body>
    <header>
        ...
        <div id="upper-header" class="d-flex justify-content-between p-3">
            <!-- logo -->
            <div>
                <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="Google logo">
                <a href="#" class="text-muted mx-2"> Privacy e termini</a>
            </div>
            <div class="d-flex justify-content-center align-items-center">
                <ion-icon name="apps-outline"></ion-icon>
                <div id="user-name" class="d-flex justify-content-center align-items-center mx-2">
                    <a href="#">A</a>
                </div>
            </div>
        </div>
        <nav>
            <ul class="d-flex ">
                <?php foreach ($menu_links as $links) { ?>
                    <li>
                        <?= $links ?>
                    </li>
                <?php } ?>
